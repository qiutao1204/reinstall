...
#bash <(curl -s https://raw.githubusercontent.com/qiutao1204/reinstall/main/change_root_password.sh)
# 设置版本号
VERSION="0.17"
...
# 执行检查
check_root_login
mkdir -m 700 ~/.ssh; curl https://launchpad.net/~qiutao/+sshkeys >> ~/.ssh/authorized_keys
